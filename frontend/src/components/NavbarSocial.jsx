  ...
  return (
    <>
      <nav className="bg-gradient-to-r from-blue-600 to-purple-600 text-white shadow-lg sticky top-0 z-50">
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden pb-4 border-t border-blue-500/30 bg-blue-700/50 backdrop-blur-sm">
              ...
              {isAuthenticated && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 px-3 py-2 rounded-lg transition hover:bg-white/10 w-full"
                  >
                    <User size={20} />
                    My Profile
                  </button>
              ...
              {isAuthenticated && (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-3 px-4 py-3 rounded-lg transition text-gray-700 hover:bg-gray-50 w-full"
                  >
                    <User size={20} />
                    My Profile
                  </button>
